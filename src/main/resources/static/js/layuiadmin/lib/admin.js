...
layui.define('view', function(exports){
  ...
  ,APP_SPREAD_SM = 'layadmin-side-spread-sm', TABS_BODY = 'layadmin-F-tabsbody-item'
  ...
  ,admin = {
    ...
    ,tabsBodyChange: function(index, options){
      ...
      admin.tabsBody(index).addClass('layui-F-show').siblings().removeClass('layui-F-show');
  ...
  element.on('nav(layadmin-pagetabs-nav)', function(elem){
    var dd = elem.parent();
    dd.removeClass(THIS);
    dd.parent().removeClass('layui-F-show');
  });
